...
# Data
x_values = np.array([6, 7, 8, 9, 10, 11])
y_values = np.array([0.49500952098055834, 0.5114085460417982, 0.5437883999919165, 
                     0.5639440789615802, 0.5806985988373958, 0.5874104296718563])
ci_lower = np.array([0.4885216727938215, 0.5028957322977581, 0.5320194421129983, 
                     0.5477692380564296, 0.5543491804426244, 0.5466770979048965])
ci_upper = np.array([0.5014973691672951, 0.5199213597858383, 0.5555573578708347, 
                     0.5801189198667307, 0.6070480172321673, 0.6281437614388161])
num_images = np.array([3714, 2056, 990, 415, 186, 61])

null_values = np.array([0.2028476987095444, 0.2200828400749844, 0.24057714646956446, 
                        0.2485353260965924, 0.2654561422127516, 0.2545488068316878])
